...
export const supportedScales = [
  { id: 'bengle-scale', displayName: 'Bengle scale', imageName: 'bengle-scale.png', aliases: [/^bengle.*scale$/i] },
  { id: 'half-decent-scale-usb', displayName: 'Half Decent Scale (USB)', imageName: 'half-decent-scale-usb.png', aliases: [/^half\s+decent\s+scale\s*\(usb\)$/i] },
  { id: 'half-decent-scale-wifi', displayName: 'Half Decent Scale (WiFi)', imageName: 'half-decent-scale-wifi.png', aliases: [/^half\s+decent\s+scale\s*\(wi-?fi\)$/i] },
  { id: 'decent-scale', displayName: 'Decent Scale', imageName: 'decent-scale.png', aliases: [/^decent\s+scale$/i] },
  { id: 'skale2', displayName: 'Skale2', imageName: 'skale2.png', aliases: [/^skale/i] },
  ...
  { id: 'acaia-scale', displayName: 'Acaia Scale', imageName: 'acaia-scale.png', aliases: [/acaia/i] },
  { id: 'felicita-arc', displayName: 'Felicita Arc', imageName: 'felicita-arc.png', aliases: [/^felicita/i] },
  { id: 'blackcoffee-scale', displayName: 'BlackCoffee Scale', imageName: 'blackcoffee-scale.png', aliases: [/^black/i] },
  { id: 'bookoo-mini-scale', displayName: 'Bookoo Mini Scale', imageName: 'bookoo-themis-mini.png', aliases: [/bookoo/i, /themis[\s_-]*mini/i] },
  ...
  { id: 'smartchef-scale', displayName: 'SmartChef Scale', imageName: 'smartchef-scale.png', aliases: [/smartchef/i] },
  ...
  { id: 'weighmaster-scale', displayName: 'WeighMaster Scale', imageName: 'weighmaster-scale.png', aliases: [/weigh\s*master/i] },
