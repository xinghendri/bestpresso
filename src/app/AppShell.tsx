...
export function AppShell({ model, connection, gatewayHost, heatingSeconds, sleepPending, machineActionError, scale, onSleep, onSearchScale, onOpenSettings, onManageProfiles }: AppShellProps) {
