...
export function AppShell({ model, connection, gatewayHost, heatingSeconds, sleepPending, machineActionError, onSleep, onOpenSettings, onManageProfiles }: AppShellProps) {
