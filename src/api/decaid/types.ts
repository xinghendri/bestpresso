...
export interface DecaidProfile { title?: string; category?: string; description?: string; steps?: DecaidProfileStep[]; target_weight?: number | null; dose_weight?: number | null }
