...
export const brewingFixture: BrewingScreenModel = {
  ...
  profiles: [
    { id: 'trendy-six-bar', name: 'Trendy 6 bar low pressure shot', category: 'D-Flow', description: 'A gentle low-pressure profile with a long, declining finish for sweet and expressive espresso.', temperature: '91', grindSetting: '13.2', dose: '20', targetYield: '42', targetPoints: [{ elapsedMs: 0, pressure: 0, flow: 0 }, { elapsedMs: 5000, pressure: 2, flow: 4 }, { elapsedMs: 9000, pressure: 6, flow: 2.8 }, { elapsedMs: 36000, pressure: 5, flow: 2.2 }] },
    { id: 'adaptive-v2', name: 'Adaptive V2', category: 'A-Flow', description: 'Adapts the extraction to puck resistance while balancing pressure and flow through the shot.', temperature: '92', grindSetting: '14.5', dose: '21', targetYield: '34', targetPoints: [{ elapsedMs: 0, pressure: 0, flow: 0 }, { elapsedMs: 4000, pressure: 1, flow: 4 }, { elapsedMs: 8000, pressure: 8.5, flow: 1.2 }, { elapsedMs: 16000, pressure: 7.5, flow: 2.8 }, { elapsedMs: 36000, pressure: 5.5, flow: 2.1 }] },
    { id: 'best-practice-light', name: 'Best practice (light roast)', category: 'Popular', description: 'A high-temperature recipe for extracting clarity and sweetness from lighter roasted coffee.', temperature: '94', grindSetting: '12.8', dose: '18', targetYield: '45', targetPoints: [{ elapsedMs: 0, pressure: 0, flow: 0 }, { elapsedMs: 7000, pressure: 2, flow: 3.5 }, { elapsedMs: 12000, pressure: 9, flow: 2 }, { elapsedMs: 40000, pressure: 6, flow: 2.5 }] },
    { id: 'turbo-bloom', name: 'Turbo bloom', category: 'Gagné', description: 'A fast, high-flow bloom followed by a short extraction for bright and juicy espresso.', temperature: '93', grindSetting: '11.8', dose: '18', targetYield: '48', targetPoints: [{ elapsedMs: 0, pressure: 0, flow: 0 }, { elapsedMs: 3000, pressure: 3, flow: 6 }, { elapsedMs: 10000, pressure: 1, flow: 0 }, { elapsedMs: 15000, pressure: 6, flow: 4 }, { elapsedMs: 30000, pressure: 4, flow: 3.5 }] },
    { id: 'gentle-sweet', name: 'Gentle and sweet', category: 'Popular', description: 'A forgiving extraction with a soft ramp and declining pressure for a round, sweet cup.', temperature: '90', grindSetting: '15.1', dose: '20', targetYield: '40', targetPoints: [{ elapsedMs: 0, pressure: 0, flow: 0 }, { elapsedMs: 8000, pressure: 3, flow: 2.5 }, { elapsedMs: 16000, pressure: 7, flow: 2.3 }, { elapsedMs: 42000, pressure: 4, flow: 1.8 }] },
    { id: 'classic-nine-bar', name: 'Classic 9 bar', category: 'Popular', description: 'A familiar flat nine-bar extraction for traditional espresso recipes.', temperature: '93', grindSetting: '13.8', dose: '18', targetYield: '36', targetPoints: [{ elapsedMs: 0, pressure: 0, flow: 0 }, { elapsedMs: 4000, pressure: 3, flow: 3 }, { elapsedMs: 8000, pressure: 9, flow: 2.4 }, { elapsedMs: 32000, pressure: 9, flow: 2.1 }] },
  ],
  previousShot: {
