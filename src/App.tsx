...
const currentPage = (): AppPage => {
  ...
  return page === 'profiles' || page === 'previous-pull' || page === 'profile-builder' || page === 'settings' ? page : 'home'
}
...
export default function App() {
  ...
  else if (page === 'settings' && !data.liveBrew.visible) screen = <SettingsScreen model={data.model} connection={data.connection} machineConnection={data.machineConnection} scale={data.scale} onClose={() => navigate('home')} onOpenDecaidSettings={() => window.location.assign(getDecaidSettingsUrl())} />
